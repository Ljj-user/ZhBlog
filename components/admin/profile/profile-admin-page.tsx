...
import { ProfileExperienceEditor } from "@/components/admin/profile/profile-experience-editor"
  ...
  return (
    <div className="space-y-4">
      <AdminPageHeader
        ...
        title="站点资料"
        description="这里维护站点资料的真实保存链路，并按独立区块组织，而不是整页一个大表单。"
      />
